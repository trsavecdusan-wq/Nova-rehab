...
class IconSettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val note = TextView(this).apply {
            text = "Vpiši slovenski napis. Aplikacija bo po potrebi prevajala z OpenAI."
            textSize = 13f
    ...
    private fun createCustomIconRow(index: Int): LinearLayout {
        ...
        etSpeech.hint = "Slovensko besedilo za govor"
        ...
        btnSave.layoutParams = LinearLayout.LayoutParams(dp(48), dp(48)).apply {
            setMargins(8, 0, 0, 0)
        }
        ...
        btnReset.layoutParams = LinearLayout.LayoutParams(dp(48), dp(48)).apply {
            setMargins(4, 0, 0, 0)
        }
    ...
    private fun createIconRow(id: String, defaultRes: Int, mgr: IconTextManager): LinearLayout {
        ...
        etSl.setText(mgr.getText(id))
        etSl.hint = "Slovensko besedilo"
        etSl.textSize = 12f
        ...
        btnSave.setOnClickListener {
            mgr.setText(id, etSl.text.toString())
            Toast.makeText(this, "Shranjeno", Toast.LENGTH_SHORT).show()
        }
        row.addView(btnSave)
